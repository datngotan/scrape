...
const HIEN_BINH_PRODUCTS = [
  {
    id: "hien_binh_vang_9999",
    name: "Hiền Bình (Vàng 9999)",
    label: "vang 9999",
  },
  {
    id: "hien_binh_vang_23k",
...
const HIEN_BINH_URL =
  "https://pc.thietbinganhvang.vn/share/facebook/vbhienbinh";
...
export const HIEN_BINH_SOURCES = HIEN_BINH_PRODUCTS.map((product) => ({
  id: product.id,
  name: product.name,
  storeName: "Hiền Bình",
  unit: "chi",
  url: HIEN_BINH_URL,
  webUrl: HIEN_BINH_URL,
  location: "Ninh Bình",
  parse: (payload) => {
