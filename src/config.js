...
import { KIM_PHONG_THAO_SOURCES } from "./sources/gold/kim_phong_thao.js";
import { KIM_TIN_SOURCES } from "./sources/gold/kim_tin.js";

export const SILVER_SOURCES = [...BAC_MAT_TRANG_SOURCES];
export const GOLD_SOURCES = [...KIM_TIN_SOURCES, ...KIM_PHONG_THAO_SOURCES];
export const SILVER_TABLE = "silver_prices_9999";
export const GOLD_TABLE = "gold_prices_9999";
